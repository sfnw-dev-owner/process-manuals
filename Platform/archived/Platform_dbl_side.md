...
- Put insulation foam pieces between each joist\
     ...
     --- 2 at 11^1^/~2~″ wide by 89^1^/~2~\" long\
     --- 7 at 14 \" wide by 89^1^/~2~\" long\
     --- use an Exacto knife with blade all the way out

- Cut the ends to fit the length, and install with silver side UP.

- Using GREAT STUFF spray cans, put lines to fill in at all the junctions between the foam and the
    joists.\
...
- Apply Liquid Nails construction adhesive to the joists that will be
    under the 2^nd^ plywood panel

- Place the 2^nd^ panel\
     --- use pivot point at the junction of the 2 panels\
     --- along the seam, nail about every 8 inches, slightly angled in towards the
     junction line and alternate the sides of the junction line.
...
- Apply Liquid Nails construction adhesive to the joists that will be
under the 3^rd^ plywood panel

- Place the 3^rd^ panel\
     --- use pivot point at the junction of the 2 panels\
     --- along the seam, nail about every 8 inches, slightly angled in
 towards the junction line and alternate the sides of the junction line.
...
- Draw a line 3½ inches from the edge on all sides\
     --- use the marking jig; it hangs from the back saw table. Using a
