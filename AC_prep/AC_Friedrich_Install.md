...
-   Remove all the installation pieces from the box.
    ...
    - bag of parts that has the remote
    - batteries

-   Set aside the remote and black foam pieces
...
-   Install the air filter and white cover.
...
## Installing the AC Outer Unit
  ...
  After the interior plywood is Installed, and both inner and exterior holes are cut open
...
Verify that the interior plywood and exterior siding are flush with the 2x4 frame opening. Trim as needed.
...
- Adjust side to side as needed. The front, bottom lip of the AC cover rests on the 2x4 framing.
...
- Install the air filter and white cover (insert bottom pins first and push in the top of the cover)
