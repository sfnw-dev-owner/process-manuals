...
- [Rendering a Manual](#rendering-a-manual)
  - [Prerequisite: custom template file](#prerequisite-custom-template-file)
...
### Prerequisite: custom template file
...
* Normal text
* Footer page number
* Customized margin widths to allow for full size images
