...
- Using the table saw set up for this, rip pieces to the required width above.  Save the remaining partial pieces for the next floor.
...
## Doorway
- Place a 3” strip of flooring across the doorway, flush with the outside of the building.  This will be secured with flexible flashing when the door is installed.  The strip can either be a single 36” piece, or be made up from scraps interlocked together (e.g. 5 x 7” = 35”). 
