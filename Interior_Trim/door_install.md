...
- Unless it is already there, install a piece of flexible flooring (~3-1/2" wide) flush with the outside edge of the exterior siding, leaving a gap with the interior flooring.
...
- If space above the door is narrow, use shims to make it even, if large
    then use a piece of 3/4" plywood, and then shims
