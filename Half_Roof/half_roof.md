```{=typst}
#title-page[
  #text(36pt, weight: "bold")[Half-Roof Assembly]
  #v(1em)
...
- Note that there are 1x6 white boards in the same rack that holds the 1x8 boards.  Do not use the narrower board for this step.
...
- Pre-drill holes for lag bolts on each of the inner rafters
  - See diagram
  - Use 13/16" spade bit
...
- Using the larger straight drill bit, drill down into each of those holes through the rafter
