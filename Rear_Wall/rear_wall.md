...
`#fullpage("images/rear_wall_01.png")`{=typst}
...
- Team leader
    - When stud are in place, draw a straight vertical line at the middle of each stud to indicate where to put the nails.
- Place
...
`#fullpage("images/rear_wall_02.png")`{=typst}
...
`#fullpage("images/rear_wall_03.png")`{=typst}
...
- Place a second 20-1/2" block horizontally below the vertical block as shown, and nail it to this block, and then through the newly installed stud, as shown in the diagram.  Make certain that the block is flush with the surface of the stud.
- Finally, put two nails through the top and bottom plates into the new stud.

`#fullpage("images/rear_wall_04.png")`{=typst}
...
`#fullpage("images/rear_wall_04b.png")`{=typst}

# Step 5

- Line the Tyvek up to be flush with the top and overlap about 6" on the sides, so that the Tyvek extends beyond the alignment posts on the side of the jig.
...
`#fullpage("images/rear_wall_05.png")`{=typst}
...
- Add 4 small pieces of flashing at the corners of the window, as shown in the figure

`#fullpage("images/rear_wall_06.png")`{=typst}
...
- Nail (PANEL NAILS)
    ...
    - along outer edge, bottom, and internal studs, every 8"
    - use chalk lines
- Position the A/C nailing template over the top center of the wall, against the jig stop marked, and make pencil marks at the spots indicated at the edges of the template. Nail (PANEL NAILS) at each mark.

`#fullpage("images/rear_wall_07.png")`{=typst}
...
`#fullpage("images/rear_wall_08.png")`{=typst}
